        ...
        <div className="glass-panel bg-[#090d16]/90 border border-white/10 rounded-2xl p-6 shadow-2xl space-y-5">
          <div className="space-y-4">
            ...
            <a
              ...
              className="w-full rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3.5 text-xs shadow-lg shadow-blue-600/30 transition-all cursor-pointer flex items-center justify-center gap-2.5"
            >
